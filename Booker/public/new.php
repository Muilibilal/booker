<?php
  ...
  if (isset($_POST['book'])) {
    ...
    $query = "INSERT INTO `bookings` (`receiver`,`transactionID`, `product`,`amount`, `status`, `phone`, `email`, `address`, `type`, `weight`, `user-id`, `info`, `date-created`) VALUES ('$receiverName', '$transID', '$productName', $amount, 'Pending', '$receiverPhone', '$receiverEmail', '$receiverAddr', '$selection', '$productWght', '$getUID', '$productDesc', '$transDate')";
