...
if (isset($_POST['signup-btn'])) {
	...
	$query = "INSERT INTO `user-data` (`first_name`, `last_name`, `username`, `password`, `phone`, `email`, `role`) VALUES ('$firstname','$lastname', '$username', '$password', '$phone', '$email', 'user')";
  ...
  <body>
    ...
    <nav class="container">
      ...
      <section>
        ...
        <button><a href="./admin/signup.html">Join us</a></button>
      </section>
    </nav>
    <!-- Nav end -->
    <div class="message">
      <?php if ($errorMsg) : ?>
        ...
        <div class="success--container">
          ...
          <div><?php echo 'You have been registered successfully.' ?></div>
        </div>
			<?php endif; ?>
    </div>
    <!-- Main start -->
