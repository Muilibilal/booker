    <?php 
      ...
      $pendingBookings = "SELECT * from `bookings` WHERE `user-id` = '$getUID' and status = 'in-progress'";
      ...
      <section class="content">
        ...
        <div class="cards">
          ...
          <div class="card">
            ...
            <p>packages in progress</p>
            <img src="../../assets/icons/in-transit.png" />
          </div>
          <div class="card">
            <span><?php echo count($failed)?></span>
            <p>failed deliveries</p>
            <img src="../../assets/icons/failed-package.png" />
          </div>
        </div>
            ...
            <table>
              ...
              <tbody>
                  <?php foreach ($all as $key => $value) {
                    if ($value["amount"] >= $avgDecider && strtolower($value["status"]) != "failed" && strtolower($value["status"]) != "in-progress" && strtolower($value["status"]) != "pending") { ?>
                    <tr>
